 ...
 const [open, setOpen] = useState(false);
  ...
  return (
    <>
      {/* ---------- HEADER ---------- */}
      <header
        className={`fixed top-0 left-0 w-full z-50 px-6 py-2 transition-colors duration-500 ${bgColor}`}
      >
...
<button
  ...
  className="flex items-center gap-2 px-4 py-2 rounded-xl bg-black text-white 
             hover:bg-gray-900 shadow-md hover:shadow-lg hover:scale-[1.05] 
  ...
  <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex justify-center items-center z-[100]">
    ...
    <div className="bg-white rounded-2xl shadow-2xl w-[420px] max-w-[90%] p-8 text-center animate-fadeIn">
      ...
      <button
        ...
        className="flex items-center justify-center gap-2 w-full bg-[#23b5b5] hover:bg-indigo-600 
