    ...
    <div className="w-full bg-gray-900 rounded-2xl border border-gray-800">
      <div className="w-full py-10 px-5">
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          <button
            onClick={() => navigate("/workflows/popular")}
        ...
        <div className="w-full flex flex-wrap gap-4">
          {prebuiltWorkflows.map((workflow, index) => {
            ...
            return (
              <div
                key={index}
                className="group relative w-[270px] bg-gray-800 rounded-xl p-3 md:p-4 border border-gray-700 hover:border-cyan-500/50 transition-all duration-300 hover:transform hover:scale-105 hover:shadow-2xl hover:shadow-cyan-500/20 cursor-pointer flex-shrink-0 h-32 md:h-36 flex flex-col justify-between"
              >
