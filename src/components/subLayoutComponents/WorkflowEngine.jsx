  ...
  return (
    <div className="w-full min-h-screen flex flex-col items-center justify-start bg-transparent">
      ...
      <div className="w-full max-w-6xl mx-auto flex flex-col gap-8 py-10 px-2 sm:px-0">
        <div className="w-full bg-gradient-to-br from-gray-950/90 to-gray-900/80 bg-opacity-80 border border-cyan-900 rounded-2xl shadow-2xl p-8 flex flex-col gap-10">
          ...
          <div className="flex flex-col md:flex-row gap-8 w-full">
            ...
            >
              <div className="min-h-[300px] bg-gradient-to-br from-cyan-900 via-black to-cyan-950 bg-opacity-80 border-2 border-cyan-700 rounded-xl p-6 flex flex-col items-center justify-center shadow-lg transition-all duration-300 group-hover:scale-[1.01] group-hover:shadow-cyan-700/30">
                ...
                <h3 className="text-2xl font-bold text-cyan-100 mb-1 group-hover:text-cyan-400 transition-colors duration-300">
                  Create Custom Workflow
                </h3>
                <p className="text-cyan-300 text-base text-center group-hover:text-cyan-200 transition-colors duration-300">
                  Build your own automated workflow from scratch with our visual
                  drag-and-drop editor
                </p>
                <div className="mt-4">
                  <div className="inline-flex items-center px-4 py-2 bg-gradient-to-r from-cyan-700 to-cyan-900 rounded-lg text-cyan-100 font-semibold hover:from-cyan-600 hover:to-cyan-800 transition-all duration-300 group-hover:shadow-lg group-hover:shadow-cyan-700/25 text-sm">
            ...
            <div className="flex-1 flex flex-col justify-center">
              <div className="bg-gradient-to-br from-cyan-1000 via-black to-cyan-950 bg-opacity-80 border border-cyan-800 rounded-xl p-6 shadow-md h-full flex flex-col justify-center">
                <MostPopular />
              </div>
            </div>
          </div>
          ...
          <div className="w-full">
            <div className="bg-gradient-to-br from-cyan-1000 via-black to-cyan-950 bg-opacity-80 border border-cyan-800 rounded-xl p-6 shadow-md">
              <Recommended />
            </div>
          </div>
