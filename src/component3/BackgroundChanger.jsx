...
const AiImageStyler = () => {
  ...
  const styles = [
    { id: "Background1", name: "Background1", description: "Background", gradient: "from-[#23b5b5] to-[#23b5b5]" },
    { id: "Background2", name: "Background2", description: "Background", gradient: "from-[#23b5b5] to-[#23b5b5]" },
    { id: "Background3", name: "Background3", description: "Background", gradient: "from-[#23b5b5] to-[#23b5b5]" },
    { id: "Background4", name: "Background4", description: "Background", gradient: "from-[#23b5b5] to-[#23b5b5]" },
  ];
      ...
      <div className="p-6 max-w-7xl mx-auto">
        <div className="grid md:grid-cols-12 gap-8">
          ...
          <div className="md:col-span-4 space-y-4">
            <h2 className="text-xl font-semibold text-white">Choose Your Background</h2>
                ...
                {styledImage ? (
                  ...
                  <div className="text-center space-y-4 text-gray-400">
                    ...
                    <div>
                      ...
                      <p className="text-sm">Upload an image and select a background to get started</p>
                    </div>
                  </div>
                )}
              </div>
