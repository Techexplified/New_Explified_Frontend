...
export default function InfiniteScroll({
  // ----- Layout / Style Props -----
  width = "25rem",             // Width of the outer wrapper
  ...
  return (
    ...
    >
      ...
      >
        {items.map((item, i) => (
          <div
            className="flex items-center justify-center p-4 text-xl text-[#44ffff] font-semibold text-center border-2 border-white rounded-[15px] select-none box-border relative"
            key={i}
            style={{
