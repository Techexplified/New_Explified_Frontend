  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const res = await axios.post(
        `${import.meta.env.VITE_APP_URL}api/bg/color`,
        formData,
        { responseType: "blob" }
      );
  ...
  return (
    <div className="bg-black text-white p-6 flex justify-center items-start">
      <div className="w-full max-w-4xl space-y-8">
        ...
        <div className="bg-black border border-neutral-800 p-6 rounded-2xl shadow-xl space-y-6 max-w-xl mx-auto">
          <input
            type="file"
            accept="image/*"
          ...
          <div>
            ...
            <input
              ...
              className="w-16 h-12 rounded-lg border-2 border-[#23b5b5] cursor-pointer"
          ...
          <button
            ...
            disabled={loading}
            className="w-full bg-gradient-to-r from-black via-cyan-400 to-[#000] text-black hover:scale-105 font-semibold py-2 rounded-md transition duration-200 animate-pulse hover:animate-none"
          >
            {loading ? (
