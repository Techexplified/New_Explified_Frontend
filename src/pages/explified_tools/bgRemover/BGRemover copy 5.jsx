          ...
          {!selectedFile ? (
            ...
            <div className="space-y-6">
              ...
              >
                ...
                {isBackgroundMode && (
                  <div className="absolute right-4 top-28 w-72 bg-neutral-700 text-gray-300 rounded-2xl shadow-2xl p-3 z-40">
          ...
          backgroundType === "color"
            ...
            ${
              selectedBackground === color ? "ring-2 ring-teal-400" : "ring-0"
                ...
                {isDesignMode && (
                  <div className="design-panel absolute right-4 top-28 w-72 bg-neutral-700 text-gray-300 rounded-2xl shadow-xl p-4 z-40">
                    {/* Add Heading */}
