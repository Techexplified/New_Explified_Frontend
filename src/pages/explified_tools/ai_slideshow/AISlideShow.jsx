    ...
    <div className="w-full h-screen flex flex-col justify-center items-center">
      ...
      <div className="flex flex-row gap-5">
        ...
        <div className="relative w-[50rem]">
          <Textarea
            isClearable
            placeholder="Type a prompt describing how your presentation looks like ?"
            minRows={8}
            classNames={{
              base: "w-full",
            }}
          ...
          <div className="absolute bottom-6 right-6">
            ...
            >
              <RiAiGenerate className="mr-1" /> <span>Generate SlideShow</span>
            </Button>
          </div>
        </div>
      ...
      <Modal isOpen={isOpen} onOpenChange={onOpenChange}>
        <ModalContent>
          {(onClose) => (
            <>
              <ModalHeader className="text-lg">Slideshow Setting</ModalHeader>
