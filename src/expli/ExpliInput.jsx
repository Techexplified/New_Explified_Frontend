...
import { FiGlobe, FiPaperclip, FiSend, FiX } from "react-icons/fi";
  ...
  return (
    ...
    >
      ...
      <div className="max-w-3xl mx-auto py-2 bg-[#111] border border-gray-800 rounded-2xl shadow-lg">
        ...
        {selectedFile && (
          <div className="mt-2 mx-3 px-3 py-2 rounded-lg bg-gray-800/50 border border-gray-700/50 flex items-center justify-between text-xs md:text-sm">
