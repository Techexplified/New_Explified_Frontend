...
function ExpliSidebar({
  ...
  return (
    <>
      ...
      {/* Main Sidebar */}
      <div
        className={` h-screen overflow-y-scroll scroll-t bg-gradient-to-b from-gray-900/50 to-black/95 backdrop-blur-2xl 
        ...
        ${sidebarOpen ? "w-76 px-6" : "w-0 px-0 overflow-hidden"}`}
      >
        {/* Top section */}
