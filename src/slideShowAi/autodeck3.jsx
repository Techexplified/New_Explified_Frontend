...
return (
  ...
  >
    ...
    <div className="flex-1 flex overflow-hidden">
      {/* LEFT: Sidebar (Slide Strip) – slightly smaller */}
      ...
      {/* CENTER: Main Stage (slightly reduced width) */}
        ...
        <div className="space-y-2">
          ...
          <div className="flex flex-col gap-2">
            <button
              ...
              className="flex-1 min-w-[120px] inline-flex items-center justify-center gap-1.5 px-3 py-1.5 rounded-md bg-[#111827] hover:bg-[#158b8b]/80 text-[12px] text-slate-200 hover:text-white border border-slate-700 hover:border-transparent transition-colors"
            >
              <Sparkles size={12} />
              <span>Prompt (AI)</span>
            </button>
