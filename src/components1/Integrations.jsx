...
const tools = [{ name: "Zapier", icon: <FaFeatherAlt />, description: "Automation between apps.", rating: 430, reviews: 89 },
    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <div className="flex flex-col lg:flex-row">
        ...
        <aside className="w-full lg:w-64 p-6 border-b lg:border-b-0 lg:border-r border-gray-800 bg-black space-y-8">
          <div>
            <h2 className="text-lg font-semibold mb-2 text-[#23b5b5]">Collections</h2>
            <ul className="space-y-2">
              {collections.map((item, idx) => (
                <li
                  key={idx}
                  onClick={() => setSelectedCollection(item)}
                  className="cursor-pointer hover:text-[#23b5b5]"
                >
                  {item}
                </li>
              ))}
        ...
        <main className="flex-1 p-6 sm:p-8 md:p-10">
          <h1 className="text-2xl font-bold text-[#23b5b5] mb-6 text-center sm:text-left">All Categories</h1>
